...
import { scanApi, ScanStatus, SeverityLevel } from "@/api/apiService";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function ScanResult() {
  ...
  useEffect(() => {
   ...
   // Animate progress bar and staged messages for pending scan
  useEffect(() => {
    if (!scanResult || scanResult.status !== "pending") return;

    setProgress(1);
    setCurrentStage(0);

    // Animate progress bar to 85% over 9 seconds
    let start = Date.now();
    const duration = 9000;
    const target = 85;
    const progressInterval = setInterval(() => {
      ...
      if (elapsed >= duration) {
        ...
        setProgress(1 + ((target - 1) * elapsed) / duration);
      }
    }, 50);

    // Show each stage every 2 seconds
    let stage = 0;
        ...
        <>
                      ...
                      <div className="flex h-2 w-full rounded-full overflow-hidden">
                        {scanResult.summary.high > 0 && (
                          <div
                            ...
                            style={{
                              width: `${
                                (scanResult.summary.high / totalFindings) * 100
                              }%`,
                            }}
                          />
                        )}
                        {scanResult.summary.medium > 0 && (
                          <div
                            ...
                            style={{
                              width: `${
                                (scanResult.summary.medium / totalFindings) *
                                100
                              }%`,
                            }}
                          />
                        ...
                        {scanResult.summary.low > 0 && (
                          <div
                            ...
                            style={{
                              width: `${
                                (scanResult.summary.low / totalFindings) * 100
                              }%`,
                            }}
                          />
                        )}
                        {scanResult.summary.info > 0 && (
                          <div
                            ...
                            style={{
                              width: `${
                                (scanResult.summary.info / totalFindings) * 100
                              }%`,
                            }}
                          />
                        )}
          ...
          scanResult.findings.length > 0 ? (
            ...
            <Alert className="bg-status-success/10 text-status-success border-status-success/20">
              ...
              <AlertDescription>
                Great news! No security vulnerabilities were found in this scan.
                Continue to monitor your application regularly.
              </AlertDescription>
            </Alert>
              ...
              <CardContent className="p-6">
                <div className="flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Your security scan is currently running. This might take a
                    few minutes to complete.
                  </p>

                  <Progress value={progress} className="w-full max-w-md" />
                  <div className="mt-4 space-y-1 w-full max-w-md text-left">
                    {progressStages.slice(0, currentStage + 1).map((msg, idx) => (
                  ...
                  <p className="text-sm text-muted-foreground mt-4">
                    You can close this page and check back later. We'll notify
                    you when the scan is complete.
                  </p>
                  
                  {/* <Progress value={1} className="w-full max-w-md" />
                  <p className="text-sm text-muted-foreground mt-4">
                    You can close this page and check back later. We'll notify
                    you when the scan is complete.
                  </p> */}
            ...
            <Alert variant="destructive">
              ...
              <AlertDescription>
                There was an issue completing this scan. Please try running the
                scan again or contact support if the problem persists.
              </AlertDescription>
            </Alert>
          )}
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="text-muted-foreground mb-6">
                The scan you're looking for doesn't exist or you don't have
